<%-- 
    ...
    Created on : Apr 24, 2023, 11:40:45 PM
    Author     : mayte
--%>
        ...
        <section class="banner-area organic-breadcrumb">
            <div class="container">
                <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                    <div class="col-first">
                        <h2 style="color:white; font-weight: bold;">Products that matched "<%= searchProd%>"</h2>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="row">
                    ...
                    <div class="sidebar-categories">
                        ...
                        <ul class="main-categories">
                            ...
                            <li class="main-nav-list">
                                <a href="BrowseCategory?categoryID=<%=c.getCategoryid()%>">
                                    <%=c.getCategoryname()%></a>
                ...
                <div class="col-xl-9 col-lg-8 col-md-7">
                    ...
                    <div class="filter-bar d-flex flex-wrap align-items-center">
                        <div class="sorting">
                            <select onchange="location.href = 'FilterOnSearch?searchProd=<%= searchProd%>&filter=' + this.value;">
