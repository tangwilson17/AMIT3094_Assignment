            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="right-element">
                        ...
                        %>
                        <a href="../LogoutCustomerController" style="padding-right:30px">Logout</a>
                            <% } else {%>
                        <a class="me-3" href="login.jsp" style="padding-right:30px">Login</a>
                                <% }%>
                        <a href="CartServlet" class="cart for-buy"><i class="icon icon-clipboard"></i><span>Cart:(0 $)</span></a>
