			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="right-element">
						<a href="../DisplayProfile" class="user-account for-buy"><i class="icon icon-user"></i><span>Account</span></a>
						<a href="cart.jsp" class="cart for-buy"><i class="icon icon-clipboard"></i><span>Cart:(0 $)</span></a>
