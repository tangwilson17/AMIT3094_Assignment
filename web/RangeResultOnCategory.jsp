...
<html lang="zxx" class="no-js">
    ...
    <%
        Double minNum = (Double) session.getAttribute("minNum");
        Double maxNum = (Double) session.getAttribute("maxNum");
    %>
    <body id="category">
        ...
        <section class="banner-area organic-breadcrumb">
            <div class="container">
                <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                    <div class="col-first">
                        <h2 style="color:white; font-weight: bold; margin-right: -25px;">Products between RM<%= String.format("%.2f", minNum)%> - RM<%= String.format("%.2f", maxNum)%> </h2>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-8 col-md-7">
                    ...
                    <div class="filter-bar d-flex flex-wrap align-items-center">
                        <div class="sorting">
                            <select onchange="location.href = 'FilterRangeOnCategory?categoryID=<%= categoryID%>&minNum=<%=minNum%>&maxNum=<%=maxNum%>&filter=' + this.value;">
