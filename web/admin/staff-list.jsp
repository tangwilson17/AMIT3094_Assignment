        ...
        <div class="nk-app-root">
            ...
            <div class="nk-main ">
                ...
                <div class="nk-wrap ">
                    ...
                    <jsp:include page="/admin/GetStaffList"></jsp:include>
                    <%
                        List<Staff> staffList = (List<Staff>) session.getAttribute("staff-list");
                    %>
                                    ...
                                    <div class="nk-block-head nk-block-head-sm">
                                        <div class="nk-block-between">
                                            <div class="nk-block-head-content">
                                                <h3 class="nk-block-title page-title">Staff Listing</h3>
                                                    ...
                                                    <div class="toggle-expand-content" data-content="pageMenu">
                                                        <ul class="nk-block-tools g-3">
                                                            <li class="nk-block-tools-opt">
                                                                ...
                                                                <a data-bs-toggle="modal" data-bs-target="#profile-edit" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Staff</span></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <tr class="nk-tb-item">
                                                ...
                                                <td class="nk-tb-col tb-col-sm">
                                                    <span class="tb-product">
                                                        ...
                                                        <span class="title"><%= staffs.getStaffName()%></span>
                                                    </span>
                                                </td>
                                                <td class="nk-tb-col">
                                                    <span class="tb-lead"><%= staffs.getEmail()%></span>
                                                </td>
                                                <td class="nk-tb-col">
                                                    <span class="tb-lead"><% out.print(staffs.getRole() == 0 ? "manager" : "staff");%></span>
                                                </td>
                                                <td class="nk-tb-col">
                                                    <span class="tb-sub"><%= staffs.getStaffContact()%></span>
                                                </td>
                                                <td class="nk-tb-col">
                                                    <%
                                                        if (staffs.getStatus() == 0) {
                                                            out.print("<span class='dot bg-warning d-sm-none'></span><span class='badge badge-sm badge-dot has-bg bg-warning d-none d-sm-inline-flex'>Inactive</span>");
                                                        } else {
                                                            out.print("<span class='dot bg-success d-sm-none'></span><span class='badge badge-sm badge-dot has-bg bg-success d-none d-sm-inline-flex'>Active</span>");
                                                        }
                                                    %>
                                                </td>
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a href="GetStaffDetails?staffId=<%= staffs.getStaffId()%>"><em class="icon ni ni-edit"></em><span>View Details</span></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </li>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body modal-body-lg">
                                    <h5 class="title">Create New Staff</h5>
                                                ...
                                                <div class="row gy-4">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-lg pt-0 pb-0" name="staff-name" value="" placeholder="">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" class="form-control form-control-lg pt-0 pb-0" name="staff-email" value="" placeholder="">
                                                            <span class="text-danger">
                                                                <%
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" class="form-control form-control-lg pt-0 pb-0 ps-2 pe-2" name="staff-password" value="" placeholder="">
                                                            <span class="text-danger">
                                                                <%
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" class="form-control form-control-lg pt-0 pb-0 ps-2 pe-2" name="staff-confirm-password" value="" placeholder="">
                                                            <span class="text-danger">
                                                                <%
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="tel" pattern="[0][1][0-9][0-9]{10-13}" class="form-control" placeholder="01234567891" name="staff-contact" value="">
                                                            <span class="text-danger">
                                                                <%
                                                    ...
                                                    <div class="col-12">
                                                        <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                                            <li>
                                                                <input type="submit" data-bs-dismiss="modal" class="btn btn-lg btn-primary" value="Add Staff">
                                                            </li>
                                                            <li>
