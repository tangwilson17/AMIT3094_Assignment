 ...
 * @author LocalMachine
 */
public class GetOrdersProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            Query query = manager.createNamedQuery("OrderList.findByOrderId");
            ...
            session.setAttribute("orders-list-detail", orderLists);
        } catch (Exception e) {
